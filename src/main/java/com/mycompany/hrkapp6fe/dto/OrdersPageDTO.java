...
public class OrdersPageDTO {
	...
	public OrdersPageDTO(List<OrdersDTO> content, PageableDTO pageable, float totalPages, float totalElements,
	...
	public List<OrdersDTO> getContent() {
		return content;
	}

	public void setContent(List<OrdersDTO> content) {
		this.content = content;
	}
