...
public class ShippersPageDTO {
	
	private List<ShippersDTO> content;
	...
	public ShippersPageDTO() {
		super();
	}

	public ShippersPageDTO(List<ShippersDTO> content, PageableDTO pageable, float totalPages, float totalElements,
	...
	public List<ShippersDTO> getContent() {
		return content;
	}

	public void setContent(List<ShippersDTO> content) {
		this.content = content;
	}
