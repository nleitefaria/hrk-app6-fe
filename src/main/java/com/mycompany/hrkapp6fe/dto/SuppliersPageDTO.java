...
public class SuppliersPageDTO {
	...
	private List<SuppliersDTO> content;
	...
	public SuppliersPageDTO() {
		super();
	}

	public SuppliersPageDTO(List<SuppliersDTO> content, PageableDTO pageable, float totalPages, float totalElements,
	...
	public List<SuppliersDTO> getContent() {
		return content;
	}

	public void setContent(List<SuppliersDTO> content) {
		this.content = content;
	}
